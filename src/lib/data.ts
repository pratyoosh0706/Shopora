...
const descriptions = {
  Tech: 'Experience the future with the new iPhone. Featuring a stunning display, a powerful new chip, and a pro camera system.',
...
const productNames = {
  Tech: Array.from({ length: 20 }, (_, i) => `iPhone ${114 + i} Pro`),
